        ...
        <div class="box">
          <div class="box-body">
            <form id="addClinic" name="addClinic" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <div class="form-group col-sm-12">
        			       <label>Imagens</label>
                        <input type="file" name="images[]" id="images[]" multiple style="margin-bottom: 10px;">
        			       <div  id="images">
                     </div>
        			</div>
              ...
              <input type="hidden" name="cmdEval" value="EditClinic">
              <input type="hidden" name="bot" value="">
              <input type="hidden" name="idclinic" value="<?= $_REQUEST['id']?>">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.open("GET", "includes/getInformation.php?cmdEval=getClinicEdit&" + query, true);
          xmlhttp.send();
      }
