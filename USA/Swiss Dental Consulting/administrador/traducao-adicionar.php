...
<html>
  <head>
    ...
    <title> | Adicionar Traduçoes</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="translation.php">Traduçoes</a></li>
        ...
        <div class="box">
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <input type="hidden" name="cmdEval" value="addtranslaction">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.open("GET", "includes/getInformation.php?cmdEval=getTranslationsNew&" + query, true);
          xmlhttp.send();
      }
