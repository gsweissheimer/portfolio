...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			scaleFontFamily: "'Camber-Md Neue', 'Camber-Md', 'Arial', sans-serif",
			...
			tooltipFontFamily: "'Camber-Md Neue', 'Camber-Md', 'Arial', sans-serif",
			...
			tooltipTitleFontFamily: "'Camber-Md Neue', 'Camber-Md', 'Arial', sans-serif",
