...
<html>
  <head>
    ...
    <title> CEROA | Adicionar Advanced Banner</title>
          ...
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
                ...
                <div class="form-group col-sm-12">
                  <label>Imagens</label>
                  <div class="col-sm-12 image-input">
                    <div class="col-sm-6">
                  ...
                  <!--<div class="col-sm-12">
                    <div class="form-group col-sm-4">
                      <span class="btn btn-primary" onclick="addImageField('.image-input')">
              ...
              <input type="hidden" name="cmdEval" value="addAdvancedBanner">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      /*function funCreateItems(){
          ...
          xmlhttp.open("GET", "includes/advanced-banner.php?cmdEval=getAdvancedBannerNew&" + query, true);
          xmlhttp.send();
      }*/
      ...
      function funGetLanguages(){
        ...
        var url = "includes/advanced-banner.php?cmdEval=getCountryLang&countryId="+countryID;
        $.ajax({
            url: url,
            type: 'POST',
            async: false,
