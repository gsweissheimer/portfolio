...
<html>
  <head>
    ...
    <title> CEROA | Adicionar Tag Advanced Banner</title>
          ...
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              <div class="col-xs-12">
                ...
                <!-- <br> -->
                <input type="" id="bannerTag" name="bannerTag" value="">
                </div>
              </div>
              <ul id="navBar" class="nav nav-tabs"></ul>
              <div id="tabContent" class="tab-content"></div>
              <button class="btn btn-right btn-primary">Guardar</button>
              <input type="hidden" name="cmdEval" value="addAdvancedBannerTag">
