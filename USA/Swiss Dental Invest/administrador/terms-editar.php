...
<html>
  <head>
    ...
    <title> CEROA | Editar Termos</title>
        ...
        <div class="box">
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <input type="hidden" name="cmdEval" value="editTerms">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                      ...
                      document.getElementById("typeTerms").value = viArrayValues[3];
          ...
          xmlhttp.open("GET", "includes/terms.php?cmdEval=getTerm&" + query, true);
          xmlhttp.send();
      }
