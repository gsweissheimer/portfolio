...
<html>
  <head>
    ...
    <title> CEROA | Editar Paises</title>
        ...
        <div class="box">
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <input type="hidden" name="cmdEval" value="editCountry">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                    ...
                    var countryInfo = JSON.parse(viArrayValues[3]);
                    var countryLang = JSON.parse(viArrayValues[4]);
                    ...
                    document.getElementById('countryName').value = countryInfo[0][1];
                    document.getElementById('countryAbb').value = countryInfo[0][2];
                    document.getElementById('timezone').value = countryInfo[0][3];
                    for(i=0; i<countryLang.length; i++){
                      funPlusSpecs(countryLang[i]);
                    }
                    document.getElementById("countryCode").innerHTML = viArrayValues[5];
                  }else{
                      //alert("ERRO");
          ...
          xmlhttp.open("GET", "includes/country.php?cmdEval=getCountry&" + query, true);
          xmlhttp.send();
      }
      ...
      $(document).on("submit", "form", function(event) {
        ...
        var idChange = 0;
        function funPlusSpecs(values=false){
          ...
          if(values != ""){
            document.getElementById("idiom_"+idChange).value = values[0];
            document.getElementById("default_"+idChange).value = values[1];
          }
