...
<html>
  <head>
    ...
    <title> CEROA | Adicionar Ebook</title>
          ...
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <div class="form-group col-sm-6">
                <label>Tag:</label>
                <select class="form-control" style="width:100%" id="tagId" name="tagId" required>
              ...
              <div class="form-group col-sm-6">
                <label>País:</label>
                <select class="form-control" style="width:100%" id="countryId" name="countryId" required>
                  <option value="">Selecionar</option>
                  <?php
                    include_once PATH_DATABASE;
                    $db = Database::getInstance();
              ...
              <input type="hidden" name="cmdEval" value="addEbook">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      $("#countryId").change(function() {
        funCreateItems(this.value);
      });

      function funCreateItems(idCountry){
          ...
          //return false;
          xmlhttp.open("GET", "includes/ebooks.php?cmdEval=getEbookTranslationForm&idC=" + idCountry, true);
          xmlhttp.send();
      }
