    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
              <h3 class="box-title">Sobre Ceroa</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                </button>
              </div>
            ...
            <div class="box-body table-responsive no-padding" style="display: none;">
              <table class="table table-hover">
                <tbody>
                  ...
                  <tr>
                    <td>2</td>
                    <td><span class="label label-warning">Sobre Ceroa</span></td>
                    <td>Advanced Banner</td>
                    <td>sobre-ceroa</td>
                  </tr> 
                  <tr>
            ...
            <div class="box-body table-responsive no-padding" style="display: none;">
              <table class="table table-hover">
                <tbody>
                  ...
                  <tr>
                    <td>6</td>
                    <td><span class="label label-success">Ceroa comemoração</span></td>
                    <td>Features</td>
                    <td>ceroa-comemoracao</td>
                  </tr>
                  <tr>
                    <td>7</td>
