...
<html>
  <head>
    ...
    <title> CEROA | Adicionar Rede Sociais</title>
        ...
        <div class="box">
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <input type="hidden" name="cmdEval" value="addSocialMedia">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.open("GET", "includes/social-media.php?cmdEval=GetSocialMediaGenericInfo&" + query, true);
          xmlhttp.send();
      }
