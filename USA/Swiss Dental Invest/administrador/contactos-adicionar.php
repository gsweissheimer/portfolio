...
<html>
  <head>
    ...
    <title> CEROA | Adicionar Contactos</title>
          ...
          <div class="box-body">
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              <div class="col-sm-12">
                  ...
                  <label>País:</label>
                  <select class="form-control select2 select2-hidden-accessible" style="width:100%" onchange="funGetLanguages()" id="countryContact" name="countryContact">
              ...
              <input type="hidden" name="cmdEval" value="addContact">
  ...
  <?php include_once("gallery.php");?>
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                    var countries = JSON.parse(viArrayValues[1]);
          ...
          xmlhttp.open("GET", "includes/contacts.php?cmdEval=getContactGeneralInfo&" + query, true);
          xmlhttp.send();
      }
