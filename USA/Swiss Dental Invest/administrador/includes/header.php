<header class="main-header">
  ...
  <a href="dashboard.php" class="logo">
    ...
    <span class="logo-mini"><img src="assets/img/swiss-simbolo.svg"  width="100%" style="padding:10px;"/></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b><img src="assets/img/ic-logo-ceroa-branco.svg"  width="100%" style="padding:10px" /></b></span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs"><?= $_COOKIE['usr_ck_name'] ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
