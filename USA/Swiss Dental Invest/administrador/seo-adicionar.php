...
<html>
  <head>
    ...
    <title> CEROA | Adicionar SEO</title>
          ...
          <div class="box-body">
            <form id="frmFaq" enctype="multipart/form-data" style="margin-bottom:20px;">
              <div class="col-lg-12">
                      ...
                      <select class="form-control select2 select2-hidden-accessible" style="width:100%" id="seoCode" name="seoCode" required>
              ...
              <input type="hidden" name="cmdEval" value="addSEO">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.open("GET", "includes/seo.php?cmdEval=getSEONew&" + query, true);
          xmlhttp.send();
      }
