...
define ('URLAMIGAVEL', 'http://localhost:8080/');
...
, $slideIndicators, $itemMainSlide, $classToAdd = 'active', $classIfNotFirstToAdd = '')
{
    ...
    if ($result = $connection->query($sqlCmdGetInfo)) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // $eleItemMainSlide = str_ireplace('{{i}}', $j + 1, $eleItemMainSlide);
