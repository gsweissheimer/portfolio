  ...
  <!-- ./wrapper -->
    ...
    <script>
      function funCreateList(vfMainTable){
          ...
          xmlhttp.open("GET", "includes/banner.php?cmdEval=getBanners", true);
          xmlhttp.send();
      }
      ...
      function funDeleteItem(vfID){
          if (confirm('Tem a certeza que pertende eliminar este banner?')) {
              ...
              xmlhttp.open("GET", "includes/banner.php?cmdEval=deleteBanner&id=" + vfID, true);
              xmlhttp.send();
          }
      }
