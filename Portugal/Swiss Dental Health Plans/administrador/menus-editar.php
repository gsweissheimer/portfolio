...
<?php $_SESSION['mainPage'] = "menus.php";?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title> GLL | Edit menus</title>
          ...
          <div class="box-body">
            <form id="frmFaq" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <div class="col-xs-12">
                ...
                <div class="form-group col-sm-3">
                  <label>Submenu Tag:</label>
                  <select class="form-control" id="submenuTagType" name="submenuTagType">
                  </select>
                </div>
                <div class="form-group col-sm-3">
              ...
              <input type="hidden" name="cmdEval" value="editMenu">
              <input type="hidden" name="idMenus" value="<?=$_REQUEST['id']?>">
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  //"true|#|$optionsCountry|#|$listNavBar|#|$listFormBar|#|$optionRank|#|$optionsTag|#|$optionsSubmenuTag|#|$recomended";
                  ...
                  if(viArrayValues[0] == "true"){
                    ...
                    document.getElementById("tagType").innerHTML = viArrayValues[5];
                    document.getElementById("submenuTagType").innerHTML = viArrayValues[6];
                    if(Number(viArrayValues[7])==0)
          ...
          xmlhttp.open("GET", "includes/menus.php?cmdEval=getMenuEdit&" + query, true);
          xmlhttp.send();
      }
