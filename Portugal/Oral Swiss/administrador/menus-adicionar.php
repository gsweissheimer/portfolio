...
<html>
  <head>
    ...
    <title> GLL | Adicionar Menus</title>
        ...
        <div class="box">
          <div class="box-body">
            <form id="frmFaq" enctype="multipart/form-data" style="margin-bottom:20px;">
              ...
              <input type="hidden" name="cmdEval" value="addNewMenu">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      $('#country').on('change', function() {
        ...
        xmlhttp.open("GET", "includes/menus.php?cmdEval=createNewMenu&idCountry=" + idCountry, true);
        xmlhttp.send();
      })
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                    ...
                    document.getElementById("submenuTagType").innerHTML = viArrayValues[2];
                      // document.getElementById("tabContent").innerHTML = viArrayValues[2];
                  }else{
                      //alert("ERRO");
          ...
          var query = window.location.search.substring(1);
          xmlhttp.open("GET", "includes/menus.php?cmdEval=initMenus&" + query, true);
          xmlhttp.send();
      }
