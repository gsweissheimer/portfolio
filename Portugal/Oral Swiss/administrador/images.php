  ...
  <!-- ./wrapper -->
    ...
    <script>
      function funCreateList(vfMainTable){
          ...
          xmlhttp.open("GET", "includes/images.php?cmdEval=getImages", true);
          xmlhttp.send();
      }
      ...
      function funDeleteItem(vfID){
          if (confirm('Tem a certeza que pertende eliminar este banner?')) {
              ...
              xmlhttp.open("GET", "includes/images.php?cmdEval=deleteImage&id=" + vfID, true);
              xmlhttp.send();
          }
      }
