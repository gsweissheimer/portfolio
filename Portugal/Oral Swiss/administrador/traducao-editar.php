    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="traducoes.php">Traduçoes</a></li>
            ...
            <form id="formMain" enctype="multipart/form-data" style="margin-bottom:20px;">
              <div class="col-xs-12">
                <div class="form-group col-sm-4">
                      <label>Código Tradução</label>
                      <input type="text" id="codeTrans" name="codeTrans" class="form-control" required>
                </div>
              </div>
              <ul id="navBar" class="nav nav-tabs"></ul>
              <div id="tabContent" class="tab-content"></div>
              <button class="btn btn-right btn-primary">Guardar</button>
              <input type="hidden" name="idCodeTrans" value="<?= $_REQUEST['id']; ?>">
              <input type="hidden" name="cmdEval" value="editTranslation">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                      ...
                      document.getElementById("codeTrans").value = viArrayValues[3];
                      $("textarea").wysihtml5({
                        toolbar: {
          ...
          xmlhttp.open("GET", "includes/getInformation.php?cmdEval=getTranslationsEdit&" + query, true);
          xmlhttp.send();
      }
