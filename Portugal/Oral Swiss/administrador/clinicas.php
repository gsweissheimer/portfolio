    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Clinicas</a></li>
        </ol>
      </section>
  ...
  <!-- ./wrapper -->
    ...
    <script>
      function funCreateList(vfMainTable){
          ...
          xmlhttp.open("GET", "includes/getInformation.php?cmdEval=getClinics", true);
          xmlhttp.send();
      }
      ...
      function funDeleteItem(vfID){
          if (confirm('Tem a certeza que pertende eliminar esta clinica')) {
              ...
              xmlhttp.open("GET", "includes/deleteInformation.php?cmdEval=deleteClinic&id=" + vfID, true);
              xmlhttp.send();
          }
      }
