...
<html>
  <head>
    ...
    <title> | Editar Especificações</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-body">
            <form id="editSpec1" name="editSpec1" enctype="multipart/form-data" style="margin-bottom:20px;">

              <div class="form-group col-sm-12">
        			       <label>Código da Especificação</label>
        			       <input class="form-control"  id="specCode" name="specCode" required> </textarea>
        			</div>
              <div class="form-group col-sm-12">
        			       <label>Default</label>
        			       <input type="checkbox" name="specDef" id="specDef" value="1">
        			</div>
              <div class="form-group col-sm-12">
              ...
              <input type="hidden" name="cmdEval" value="editSpec">
              <input type="hidden" name="idSpec" id="idSpec">
              <input type="hidden" name="idSpecTrans" id="idSpecTrans">
  ...
  <!-- ./wrapper -->
    ...
    <script>
      ...
      function funCreateItems(){
          ...
          xmlhttp.onreadystatechange = function() {
              if (this.readyState == 4 && this.status == 200) {
                  ...
                  if(viArrayValues[0] == "true"){
                      ...
                      var specData = JSON.parse(viArrayValues[4]);
                      document.getElementById('idSpec').value = specData[0][0];
                      document.getElementById('categories').value = specData[0][1];
                      document.getElementById('specCode').value = specData[0][2];
                      document.getElementById('idSpecTrans').value = specData[0][3];
                      if (specData[0][4] = 1){
                        document.getElementById('specDef').checked = true;
                      }
          ...
          xmlhttp.open("GET", "includes/getInformation.php?cmdEval=getSpec&" + query, true);
          xmlhttp.send();
      }

      $('form[name=editSpec1]').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if(response[0] == "true"){
              ...
              document.getElementById("editSpec1").reset();
            }
          },
