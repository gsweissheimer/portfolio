;(function($) {
    ...
    if(window.location.pathname.split('/')[1] === "fale-connosco") {
        $(".header_menu_area, .mobile_menu").addClass("navbar_fixed");
    } else {
        navbarFixed();
     }
    ...
    /*  Explor Room Slider
    /*----------------------------------------------------*/
    function fillter_slider2(){
        if ( $('.fillter_slider2').length ){
            $('.fillter_slider2').owlCarousel({
                loop:true,
                margin: 6,
                items: 4,
                nav:true,
    ...
    /*  footeer_slider
    /*----------------------------------------------------*/
    function footeer_slider(){
        if ( $('.footeer_slider').length ){
            $('.footeer_slider').owlCarousel({
                loop:true,
                margin: 6,
                items: 1,
                nav:true,
    ...
    $('.bottom_slider').owlCarousel({
        ...
        smartSpeed: 1500,
        dots:true, 
        navContainerClass: 'bottom_slider',
        navText: ['<i class="ion-ios-arrow-left"></i>','<i class="ion-ios-arrow-right"></i>'],
        responsiveClass: true,
        responsive: {
            0: {
    ...
    //}
            $('#villa_slider3').owlCarousel({
                ...
                smartSpeed: 1500,
                dots:true, 
                navContainer: '#villa_slider3',
                navText: ['<i class="ion-ios-arrow-left"></i>','<i class="ion-ios-arrow-right"></i>'],
                responsiveClass: true,
                
            })

            $('#villa_slider4').owlCarousel({
                loop:true,
                margin: 0,
                items: 1,
                nav:true,
	 ...
	 function latest_project(){
        if ( $('.our_projects_area, .project_full_inner, .blog_inner_fillter, .blog_ms_inner').length ){
            ...
            $(".isotope_fillter li").on('click',function(){
                ...
                var selector = $(this).attr("data-filter");
                $(".projects_inner, .project_full_inner, .blog_inner_fillter, .blog_ms_inner, .ms_project_inner").isotope({
                    filter: selector,
                    animationOptions: {
                        duration: 450,
                        easing: "linear",
