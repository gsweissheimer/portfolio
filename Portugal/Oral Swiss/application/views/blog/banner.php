            ...
            <section class="home_slider">
                <div id="home_full_slider" class="rev_slider fullscreenbanner" data-version="5.3.1.6">
                    <ul>    <!-- SLIDE  -->
                        ...
                        <!-- MAIN IMAGE -->
                            <?php
                                echo funGetAdvancedBanners('blog_banner_topo', '
                            ...
                            <!-- LAYER NR. 1 -->
                                    <!-- TRADUÇÃO   blog_banner_text_2a e blog_banner_text_2b  -->
                            <div class="slider_text_box">
                                <div class="tp-caption tp-resizeme text_1" 
                                    ...
                                    <span class="banner"><?=blog_banner_text_2a?><br><?=blog_banner_text_2b?></span>  
                                  </div>
