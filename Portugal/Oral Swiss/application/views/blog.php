<!DOCTYPE html>
    ...
    <script type="text/javascript">
        ...
        $("#form_contato_blog").on("submit", function(e){
          ...
          //document.getElementById("btn_form_contact_blog").disabled = true;
          $("#btn_form_contact_blog").disabled = true;
                 ...
                 if (res.status == 'success') {
                    Swal.fire({
                      ...
                      onClose: function(){
                        ...
                        $("#btn_form_contact_blog").disabled = false;
                      }
                    });
        ...
        /*var position = $('#top-sessao-blog').offset().top;
