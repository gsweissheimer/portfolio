   ...
   <!--================3ra sesao =================-->
            <section class="latest_project white_cl mobil2">
                <div class="container" style="">
                    <div class="l_text team_inner margin-text-home">
                        <?php
                       ...
                       ?>
                        <div class="float-md-right">
                            ...
                            <div class="flex-filter">                             
                                <!-- TRADUÇÃO   filtrar-->
                                <div style="" class="" style="width: 50%">
                                   <label><?=filtrar?></label> 
                                </div>
                                <div style="" class="" style="width: 50%">
                                    
                                    <select class="form-control selecter" value="" id="produtos" style="">
                                        <?php
                                        echo funGetSlide('home_four_filter','','','                                
