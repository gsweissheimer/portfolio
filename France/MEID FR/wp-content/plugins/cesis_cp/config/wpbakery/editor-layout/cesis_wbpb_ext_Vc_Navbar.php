 ...
 *
 */
class cesis_wbpb_ext_Vc_Navbar extends Vc_Navbar {
	 ...
	 * @return string
	 */
	public function getControlAddBlock() {
		if ( vc_user_access()
			     ->part( 'shortcodes' )
...
<<<HTML
				<li>
			       <a   href="javascript:;"
			            class="vc_icon-btn -blocks-btn"
			            data-model-id="vc_element"
			            id="cesis_TM-button--show-blocks-list"
			            title="$title"
			            >
			            $icon
			       </a>
