<?php
/**
 * The template for displaying Writter single post.
 *
...
<main id="cesis_main" class="site-main vc_full_width_row_container" role="main">
  ...
  <?php if($post_navigation == 'yes' && get_adjacent_post(false, '', true) || $post_navigation == 'yes' && get_adjacent_post(false, '', false) ) { ?>
